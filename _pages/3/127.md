...
Try a [transit simulator][7] that demonstrates how a planet passing in front of its parent star can lead to the planet’s detection. Follow the instructions to run the animation on your computer.
